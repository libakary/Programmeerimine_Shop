...
namespace TARge21Shop.ApplicationServices.Services
{
    public class WeatherForecastsServices : IWeatherForecastsServices
	{
		public async Task<WeatherResultDto> WeatherDetail(WeatherResultDto dto)
		{
			...
			string apikey = "md7asVW4BJQKA8m9eRYiUqversYStI7s";
			var url = $"http://dataservice.accuweather.com/forecasts/v1/daily/1day/127964?apikey=%20%09md7asVW4BJQKA8m9eRYiUqversYStI7s%20&metric=true";
